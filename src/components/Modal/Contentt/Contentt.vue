        ...
        <div class="post">
            <div class="post-item" v-for="item,index in getPosts" :key="item.id">
                ...
                <div class="post-item-content">
                    ...
                    <br />
                    <span class="post-item-content_body">{{item.body}}</span>
                    <div class="post-item-content-bottom">
                        ...
                        <div class="post-item-content-viewdetails">
                            <router-link :to="{name: 'details', params: {idPosts: item.id}}">
                                <a-button type="">{{$t("content.viewDetails")}}
